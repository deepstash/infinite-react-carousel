...
var Slider = /*#__PURE__*/function (_Component) {
  ...
  function Slider(props) {
    ...
    _this.handleWheel = _listener.handleWheel.bind(_assertThisInitialized(_this)); // Init the slide elements
  ...
  _createClass(Slider, [{
    ...
    value: function componentDidMount() {
      this.isMounted = true;
      window.addEventListener('resize', this.handleResize); // Re-init the slide elements now that the component is mounted and we definetelly have access to the window width
